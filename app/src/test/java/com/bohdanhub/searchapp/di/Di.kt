    ...
    return object : UrlFetcher {
        override suspend fun fetch(url: String): String = withContext(Dispatchers.IO) {
            ...
            return@withContext when (index) {
                ...
                1 -> {
                    delay(10_000); "{ https://7.com , https://8.com , https://9.com , }"
                }
                ...
                5 -> {
                    delay(1_000);"{ https://20.com , https://21.com , https://22.com , https://23.com , }"
                }
                ...
                13 -> "{ https://46.com , }"
                14 -> {
                    delay(500);"{ https://47.com , https://48.com , https://49.com , https://50.com , }"
                }
                ...
                35 -> {
                    delay(800);"{ https://63.com , https://64.com , https://65.com , https://66.com , }"
                }
                38 -> "{ https://67.com , }"
                39 -> "{ https://68.com , }"
                45 -> {
                    delay(300);"{ https://69.com , https://70.com , https://71.com , }"
                }
                58 -> "{ https://72.com , }"
                63 -> {
                    delay(5_000);"{ https://73.com , }"
                }
